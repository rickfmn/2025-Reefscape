...
public final class Constants
{
 ...
 public static final class AutonConstants
 {
  ...
  public static final class VisionConstants {
    ...
    public static final Transform3d reefOffset_L2_Right = new Transform3d(Units.inchesToMeters(28.0), Units.inchesToMeters(6.5), Units.inchesToMeters(12),new Rotation3d(0, 0, Math.PI));
    public static final Transform3d reefOffset_L2_Left = new Transform3d(Units.inchesToMeters(28.0), Units.inchesToMeters(-6.5), Units.inchesToMeters(-12),new Rotation3d(0, 0, Math.PI));
